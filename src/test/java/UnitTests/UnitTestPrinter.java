...
public class UnitTestPrinter {
    ...
    public void setupBefore() {
        this.IncorrectMachine = new BmwCar("name", "car.BmvCar", 0, 0, 0);
        this.CorrectMachine = new BmwCar("name", "car.BmvCar", 1, 1, 1);
    }
...
//        Printer printer = new Printer();
        ...
        Assert.assertTrue("Method return incorrect message. The returned msg is:" + returned + ". Expected msg must " +
